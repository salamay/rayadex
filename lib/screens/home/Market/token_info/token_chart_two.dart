...
class TokenChartTwo extends StatefulWidget {
  List<MarketChartData> data;
  TokenChartTwo({required this.data});

  @override
  State<TokenChartTwo> createState() => _TokenChartTwoState();
}

class _TokenChartTwoState extends State<TokenChartTwo> {
                    ...
                    child: Chart(
                      ...
                      variables: {
                        ...
                        'price': Variable(
                          ...
                          scale: LinearScale(min: min,max: max, tickCount: 5,niceRange: true),
                        ),
                      },
                      marks: [
                        LineMark(
                      ...
                      axes: [
                        ...
                        AxisGuide(
                          ...
                          grid: PaintStyle(
                            strokeColor: themeController.isDark?primary_color:Colors.white,
                            strokeWidth: 1,
                          ),
                        )
