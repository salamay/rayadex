...
class Global{
  static final List<SupportedCoin> coins=[
    SupportedCoin(asset_name: CoinName.XRP.name, coinImage: "assets/icon/xrp.png", coinGekoId: 'ripple',wallet_BIP44path: "m/44'/144'/0'/0/0",coinType: CoinType.COIN),
    ...
    SupportedCoin(asset_name: CoinName.Ethereum.name, coinImage: "assets/icon/ethereum.png", coinGekoId: 'ethereum',wallet_BIP44path: "m/44'/60'/0'/0/0",coinType: CoinType.COIN),
